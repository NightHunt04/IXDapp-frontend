...
function Navbar () {
    ...
    return (
        <div className="w-full px-11 md:px-96 py-7 md:py-9 flex top-0 z-30 fixed items-center backdrop-blur-sm bg-[#0a0a0ace] justify-between border-b-[1px] border-[#303030]">
            <div onClick={() => {
                navigate('/')
